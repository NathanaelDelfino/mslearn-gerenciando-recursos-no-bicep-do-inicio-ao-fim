...
// Define the names for resources (Variables).
...
//Define the app service plan, app service, log analytics workspace, 
//application insights, storage account, and SQL server.
